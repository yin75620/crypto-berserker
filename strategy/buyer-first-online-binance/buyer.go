...
const version = "0.9.0-0005-BinanceBuy"

type Buyer struct {
	mBinance *binance.Binance
	init     BuyerInit
}
...
func (b *Buyer) SetInit() {
	...
	b.mBinance = binance.NewBinance(http.DefaultClient)
	b.mBinance.SetInitByIni("main.ini")
...
func (b *Buyer) stratStrategy() int64 {
	...
	co := exc.CoinPair{b.init.coinName, "USDT"}
	exchange.DeleteAllOrders(co.GetLinkMakertNameUpper())
...
func (b *Buyer) OrderBoth(exchange *binance.Binance, baseCoin string) {
